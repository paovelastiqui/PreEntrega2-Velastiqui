...
export const Checkout = () => {
    ...
    const handleSubmit = (e) => {
        ...
        createOrdenCompra(cliente, totalPrice(), aux2, new Date().toLocaleDateString('es-AR', { timeZone: Intl.DateTimeFormat().resolvedOptions().timeZone }))
            .then(ordenCompra => {
                toast.success(`🛒 Gracias por comprar con nosotros, su orden de compra es: ${ordenCompra.id} por un total de $${totalPrice()}. En breve nos contactaremos con usted para realizar el envío`, {
                    position: "top-right",
                    autoClose: 5000,
                    hideProgressBar: false,
                    closeOnClick: true,
